// Generated by Swift version 6.0-dev (LLVM cef183591317ec7, Swift 66e311074bff491)
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("SwiftLib", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace SwiftLib SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("SwiftLib") {
namespace _impl {
extern "C" {
#endif

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_SwiftLib_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_SwiftLib_uint64_t_0_8_void_ptr_8_16 swift_interop_passDirect_SwiftLib_uint64_t_0_8_void_ptr_8_16(const char * _Nonnull value) {
  struct swift_interop_passStub_SwiftLib_uint64_t_0_8_void_ptr_8_16 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
  return result;
}

SWIFT_EXTERN size_t $s8SwiftLib30DisplayStringAndReturnStrCount3msgSuSS_tF(struct swift_interop_passStub_SwiftLib_uint64_t_0_8_void_ptr_8_16 msg) SWIFT_NOEXCEPT SWIFT_CALL; // DisplayStringAndReturnStrCount(msg:)
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_SwiftLib_void_ptr_0_8 {
  void * _Nullable _1;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_SwiftLib_void_ptr_0_8(char * _Nonnull result, struct swift_interop_returnStub_SwiftLib_void_ptr_0_8 value) {
  memcpy(result + 0, &value._1, 8);
}

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_SwiftLib_void_ptr_0_8_bool_8_9 {
  void * _Nullable _1;
  bool _2;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_SwiftLib_void_ptr_0_8_bool_8_9 swift_interop_passDirect_SwiftLib_void_ptr_0_8_bool_8_9(const char * _Nonnull value) {
  struct swift_interop_passStub_SwiftLib_void_ptr_0_8_bool_8_9 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 1);
  return result;
}

SWIFT_EXTERN struct swift_interop_returnStub_SwiftLib_void_ptr_0_8 $s8SwiftLib19FibonacciCalculatorV4agesSaySiGvg(struct swift_interop_passStub_SwiftLib_void_ptr_0_8_bool_8_9 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_SwiftLib_void_ptr_0_8_bool_8_9 {
  void * _Nullable _1;
  bool _2;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_SwiftLib_void_ptr_0_8_bool_8_9(char * _Nonnull result, struct swift_interop_returnStub_SwiftLib_void_ptr_0_8_bool_8_9 value) {
  memcpy(result + 0, &value._1, 8);
  memcpy(result + 8, &value._2, 1);
}

SWIFT_EXTERN struct swift_interop_returnStub_SwiftLib_void_ptr_0_8_bool_8_9 $s8SwiftLib19FibonacciCalculatorV15printInvocationACSb_tcfC(bool printInvocation) SWIFT_NOEXCEPT SWIFT_CALL; // init(printInvocation:)
SWIFT_EXTERN uint32_t $s8SwiftLib19FibonacciCalculatorV9fibonacciys6UInt32VAFF(uint32_t value, struct swift_interop_passStub_SwiftLib_void_ptr_0_8_bool_8_9 _self) SWIFT_NOEXCEPT SWIFT_CALL; // fibonacci(_:)
struct SwiftLib_FibonacciCalculator {
  _Alignas(8) char _storage[9];
};

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_SwiftLib_uint64_t_0_8 {
  uint64_t _1;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_SwiftLib_uint64_t_0_8 swift_interop_passDirect_SwiftLib_uint64_t_0_8(const char * _Nonnull value) {
  struct swift_interop_passStub_SwiftLib_uint64_t_0_8 result;
  memcpy(&result._1, value + 0, 8);
  return result;
}

SWIFT_EXTERN ptrdiff_t $s8SwiftLib0A11ToCXXStructV1xSivg(struct swift_interop_passStub_SwiftLib_uint64_t_0_8 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s8SwiftLib0A11ToCXXStructV1xSivs(ptrdiff_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN ptrdiff_t $s8SwiftLib0A11ToCXXStructV3set1xS2i_tF(ptrdiff_t x, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // set(x:)
struct SwiftLib_SwiftToCXXStruct {
  _Alignas(8) char _storage[8];
};

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_SwiftLib_uint64_t_0_8 {
  uint64_t _1;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_SwiftLib_uint64_t_0_8(char * _Nonnull result, struct swift_interop_returnStub_SwiftLib_uint64_t_0_8 value) {
  memcpy(result + 0, &value._1, 8);
}

SWIFT_EXTERN struct swift_interop_returnStub_SwiftLib_uint64_t_0_8 $s8SwiftLib06returnA11ToCXXStruct1xAA0adE0VSi_tF(ptrdiff_t x) SWIFT_NOEXCEPT SWIFT_CALL; // returnSwiftToCXXStruct(x:)
...
SWIFT_INLINE_THUNK swift::UInt DisplayStringAndReturnStrCount(const swift::String& msg) noexcept SWIFT_SYMBOL("s:8SwiftLib30DisplayStringAndReturnStrCount3msgSuSS_tF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::$s8SwiftLib30DisplayStringAndReturnStrCount3msgSuSS_tF(_impl::swift_interop_passDirect_SwiftLib_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(msg)));
}

class SWIFT_SYMBOL("s:8SwiftLib19FibonacciCalculatorV") FibonacciCalculator;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<SwiftLib::FibonacciCalculator> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_FibonacciCalculator;

// Type metadata accessor for FibonacciCalculator
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s8SwiftLib19FibonacciCalculatorVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:8SwiftLib19FibonacciCalculatorV") FibonacciCalculator final {
public:
  SWIFT_INLINE_THUNK ~FibonacciCalculator() noexcept {
    auto metadata = _impl::$s8SwiftLib19FibonacciCalculatorVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK FibonacciCalculator(const FibonacciCalculator &other) noexcept {
    auto metadata = _impl::$s8SwiftLib19FibonacciCalculatorVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK FibonacciCalculator &operator =(const FibonacciCalculator &other) noexcept {
    auto metadata = _impl::$s8SwiftLib19FibonacciCalculatorVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK FibonacciCalculator &operator =(FibonacciCalculator &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER FibonacciCalculator(FibonacciCalculator &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  SWIFT_INLINE_THUNK swift::Array<swift::Int> getAges() const SWIFT_SYMBOL("s:8SwiftLib19FibonacciCalculatorV4agesSaySiGvp");
  static SWIFT_INLINE_THUNK FibonacciCalculator init(bool printInvocation) SWIFT_SYMBOL("s:8SwiftLib19FibonacciCalculatorV15printInvocationACSb_tcfc");
  SWIFT_INLINE_THUNK uint32_t fibonacci(uint32_t value) const SWIFT_SYMBOL("s:8SwiftLib19FibonacciCalculatorV9fibonacciys6UInt32VAFF");
private:
  SWIFT_INLINE_THUNK FibonacciCalculator() noexcept {}
  static SWIFT_INLINE_THUNK FibonacciCalculator _make() noexcept { return FibonacciCalculator(); }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage; }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage; }

  alignas(8) char _storage[9];
  friend class _impl::_impl_FibonacciCalculator;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s8SwiftLib19FibonacciCalculatorVD;
  static inline constexpr $s8SwiftLib19FibonacciCalculatorVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_FibonacciCalculator {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(FibonacciCalculator &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const FibonacciCalculator &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER FibonacciCalculator returnNewValue(T callable) {
    auto result = FibonacciCalculator::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<SwiftLib::FibonacciCalculator> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return SwiftLib::_impl::$s8SwiftLib19FibonacciCalculatorVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<SwiftLib::FibonacciCalculator> = true;
template<>
struct implClassFor<SwiftLib::FibonacciCalculator> { using type = SwiftLib::_impl::_impl_FibonacciCalculator; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:8SwiftLib5HelloC") Hello;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<SwiftLib::Hello> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_Hello;
// Type metadata accessor for Hello
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s8SwiftLib5HelloCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:8SwiftLib5HelloC") Hello : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
protected:
  SWIFT_INLINE_THUNK Hello(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_Hello;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s8SwiftLib5HelloCD;
  static inline constexpr $s8SwiftLib5HelloCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_Hello {
public:
static SWIFT_INLINE_THUNK Hello makeRetained(void * _Nonnull ptr) noexcept { return Hello(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<SwiftLib::Hello> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return SwiftLib::_impl::$s8SwiftLib5HelloCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<SwiftLib::Hello> { using type = SwiftLib::_impl::_impl_Hello; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:8SwiftLib0A11ToCXXStructV") SwiftToCXXStruct;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<SwiftLib::SwiftToCXXStruct> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_SwiftToCXXStruct;

// Type metadata accessor for SwiftToCXXStruct
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s8SwiftLib0A11ToCXXStructVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:8SwiftLib0A11ToCXXStructV") SwiftToCXXStruct final {
public:
  SWIFT_INLINE_THUNK ~SwiftToCXXStruct() noexcept {
    auto metadata = _impl::$s8SwiftLib0A11ToCXXStructVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK SwiftToCXXStruct(const SwiftToCXXStruct &other) noexcept {
    auto metadata = _impl::$s8SwiftLib0A11ToCXXStructVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK SwiftToCXXStruct &operator =(const SwiftToCXXStruct &other) noexcept {
    auto metadata = _impl::$s8SwiftLib0A11ToCXXStructVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK SwiftToCXXStruct &operator =(SwiftToCXXStruct &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER SwiftToCXXStruct(SwiftToCXXStruct &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  SWIFT_INLINE_THUNK swift::Int getX() const SWIFT_SYMBOL("s:8SwiftLib0A11ToCXXStructV1xSivp");
  SWIFT_INLINE_THUNK void setX(swift::Int value) SWIFT_SYMBOL("s:8SwiftLib0A11ToCXXStructV1xSivp");
  SWIFT_INLINE_THUNK swift::Int set(swift::Int x) SWIFT_SYMBOL("s:8SwiftLib0A11ToCXXStructV3set1xS2i_tF");
private:
  SWIFT_INLINE_THUNK SwiftToCXXStruct() noexcept {}
  static SWIFT_INLINE_THUNK SwiftToCXXStruct _make() noexcept { return SwiftToCXXStruct(); }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage; }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage; }

  alignas(8) char _storage[8];
  friend class _impl::_impl_SwiftToCXXStruct;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s8SwiftLib0A11ToCXXStructVD;
  static inline constexpr $s8SwiftLib0A11ToCXXStructVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_SwiftToCXXStruct {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(SwiftToCXXStruct &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const SwiftToCXXStruct &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER SwiftToCXXStruct returnNewValue(T callable) {
    auto result = SwiftToCXXStruct::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<SwiftLib::SwiftToCXXStruct> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return SwiftLib::_impl::$s8SwiftLib0A11ToCXXStructVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<SwiftLib::SwiftToCXXStruct> = true;
template<>
struct implClassFor<SwiftLib::SwiftToCXXStruct> { using type = SwiftLib::_impl::_impl_SwiftToCXXStruct; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_INLINE_THUNK SwiftToCXXStruct returnSwiftToCXXStruct(swift::Int x) noexcept SWIFT_SYMBOL("s:8SwiftLib06returnA11ToCXXStruct1xAA0adE0VSi_tF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::_impl_SwiftToCXXStruct::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_SwiftLib_uint64_t_0_8(result, _impl::$s8SwiftLib06returnA11ToCXXStruct1xAA0adE0VSi_tF(x));
  });
}



  SWIFT_INLINE_THUNK swift::Array<swift::Int> FibonacciCalculator::getAges() const {
  return swift::_impl::_impl_Array<swift::Int>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_SwiftLib_void_ptr_0_8(result, _impl::$s8SwiftLib19FibonacciCalculatorV4agesSaySiGvg(_impl::swift_interop_passDirect_SwiftLib_void_ptr_0_8_bool_8_9(_getOpaquePointer())));
  });
  }
  SWIFT_INLINE_THUNK FibonacciCalculator FibonacciCalculator::init(bool printInvocation) {
  return _impl::_impl_FibonacciCalculator::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_SwiftLib_void_ptr_0_8_bool_8_9(result, _impl::$s8SwiftLib19FibonacciCalculatorV15printInvocationACSb_tcfC(printInvocation));
  });
  }
  SWIFT_INLINE_THUNK uint32_t FibonacciCalculator::fibonacci(uint32_t value) const {
  return _impl::$s8SwiftLib19FibonacciCalculatorV9fibonacciys6UInt32VAFF(value, _impl::swift_interop_passDirect_SwiftLib_void_ptr_0_8_bool_8_9(_getOpaquePointer()));
  }
  SWIFT_INLINE_THUNK swift::Int SwiftToCXXStruct::getX() const {
  return _impl::$s8SwiftLib0A11ToCXXStructV1xSivg(_impl::swift_interop_passDirect_SwiftLib_uint64_t_0_8(_getOpaquePointer()));
  }
  SWIFT_INLINE_THUNK void SwiftToCXXStruct::setX(swift::Int value) {
  _impl::$s8SwiftLib0A11ToCXXStructV1xSivs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Int SwiftToCXXStruct::set(swift::Int x) {
  return _impl::$s8SwiftLib0A11ToCXXStructV3set1xS2i_tF(x, _getOpaquePointer());
  }

// Unavailable in C++: Swift type alias 'Signal'.

class SwiftProtocol { } SWIFT_UNAVAILABLE_MSG("protocol 'SwiftProtocol' can not yet be represented in C++");

// Unavailable in C++: Swift global function 'fuck()'.

// Unavailable in C++: Swift global function 'take(body:)'.
